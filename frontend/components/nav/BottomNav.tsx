...
const TABS = [
  ...
  { href: "/profiles", label: "House", icon: Users },
] as const;

/** A floating pill rather than a full-width bar — keeps the black canvas visible. */
export function BottomNav() {
  ...
  return (
    <nav
      aria-label="Main"
      className="fixed inset-x-0 bottom-0 z-40 pb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)]"
    >
