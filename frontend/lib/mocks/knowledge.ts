...
export const CROSS_REACTIVITY: Record<
  string,
  { triggers: string[]; note: string }
> = {
  Latex: {
...
export const INGREDIENT_EXPLAINERS: Record<string, string> = {
  ...
  "sodium caseinate":
    "A milk protein pulled out of casein. It is dairy, even when the label says 'non-dairy creamer'.",
  "milk solids":
    "What is left when water is removed from milk — full dairy protein and lactose.",
  ...
  "palm oil":
    "A cheap vegetable fat from oil-palm fruit. Not an allergen, but high in saturated fat.",
  "invert sugar syrup":
    "Sugar split into glucose and fructose so it stays soft and does not crystallise.",
  lecithin:
    "An emulsifier that keeps fats and water mixed. Soy is the usual source.",
  "cocoa butter":
    "The fat pressed from cocoa beans. Despite the name, it contains no dairy.",
